(function () {
  ...
  function injectStyle() {
    ...
    style.textContent = [
      ...
      ".dpp-migration-notice__button--link{background:#e6edf5;color:#024390;padding-left:14px;padding-right:14px}",
      ".dpp-migration-notice__button--link:hover{background:#d8e4f0}",
